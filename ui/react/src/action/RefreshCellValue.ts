...
class RefreshCellValue extends TableAction {
    ...
    public static deserialize(input: any) {
        ...
        return new RefreshCellValue(sheetName, tableName, rowIndex, columnIndex, value);
    }
    ...
    public wrapper(): Action {
        ...
        action.refreshCellValue = this;
        return action;
    }

}

export default RefreshCellValue;

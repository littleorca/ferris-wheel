...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getFromSheetName()
        .equals(other.getFromSheetName())) return false;
    if (!getFromAssetName()
        .equals(other.getFromAssetName())) return false;
    if (!getToSheetName()
        .equals(other.getToSheetName())) return false;
    if (!getToAssetName()
        .equals(other.getToAssetName())) return false;

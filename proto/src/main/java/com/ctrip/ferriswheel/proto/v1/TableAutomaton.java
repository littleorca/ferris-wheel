...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    boolean result = true;
    result = result && getAutomatonCase().equals(
        other.getAutomatonCase());
    if (!result) return false;
    switch (automatonCase_) {
      case 1:
        result = result && getQueryAutomaton()
            .equals(other.getQueryAutomaton());
        break;
      case 2:
        result = result && getPivotAutomaton()
            .equals(other.getPivotAutomaton());
        break;
      case 0:
      default:
    }
